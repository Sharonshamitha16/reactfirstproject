import "./Navbar.css"
import img from  "./Assets/human1.webp"
const Home =()=>{
    return(
        <div className="row bg-black flex justify-between h-lvh ">
            <div className="col mx-150 ml-20 mt-20">
                ...
                <h1 className="text-white text-4xl font-extrabold font-mono">I'm  a<span className="text-amber-400"> Web    Designer   </span>based in london</h1>
